...
pub use vardct::{
    ...
    assemble_vardct_srgb8_image, assemble_vardct_srgb8_image_for_pass,
    assemble_vardct_srgb16_image, assemble_vardct_srgb16_image_for_pass, assemble_vardct_xyb_image,
